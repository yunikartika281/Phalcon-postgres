...
use Pbackbone\Validation\RoleCreateDataValidation as CreateDataValidation;
use Pbackbone\Validation\RoleReadDataValidation as ReadDataValidation;
use Pbackbone\Validation\RoleReadDataByIdValidation as ReadDataByIdValidation;
use Pbackbone\Validation\RoleUpdateDataByPutValidation as UpdateDataByPutValidation;
use Pbackbone\Validation\RoleUpdateDataByPatchValidation as UpdateDataByPatchValidation;
use Pbackbone\Validation\RoleDeleteDataValidation as DeleteDataValidation;

class RoleController extends \Pbackbone\Controller\BaseController
{
    /**
     * data name variable
     *
