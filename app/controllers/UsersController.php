...
use Pbackbone\Validation\UsersCreateDataValidation as CreateDataValidation;
use Pbackbone\Validation\UsersReadDataValidation as ReadDataValidation;
use Pbackbone\Validation\UsersReadDataByIdValidation as ReadDataByIdValidation;
use Pbackbone\Validation\UsersUpdateDataByPutValidation as UpdateDataByPutValidation;
use Pbackbone\Validation\UsersUpdateDataByPatchValidation as UpdateDataByPatchValidation;
use Pbackbone\Validation\UsersDeleteDataValidation as DeleteDataValidation;

class UsersController extends \Pbackbone\Controller\BaseController
{
    /**
     * data name variable
     *
        ...
        if ($dataTotal > 0) {
            foreach ($dataDbs as $dataDb) {
                ...
                if (isset($field)) {
                    ...
                    $responseData[$no]["firstName"] = $dataDb->getFirstName();
                    $responseData[$no]["lastName"] = $dataDb->getLastName();
                    $responseData[$no]["username"] = $dataDb->getUsername();
                    $responseData[$no]["email"] = $dataDb->getEmail();
                    $responseData[$no]["phone"] = $dataDb->getPhone();
                    $responseData[$no]["password"] = $dataDb->getPassword();
                    $responseData[$no]["pin"] = $dataDb->getPin();
                    $responseData[$no]["isActive"] = $dataDb->getIsActive();
                    $responseData[$no]["isLogin"] = $dataDb->getIsLogin();
                    $responseData[$no]["isResetPassword"] = $dataDb->getIsResetPassword();
                    $responseData[$no]["lastLogin"] = $dataDb->getLastLogin();
                    $responseData[$no]["profilePic"] = $dataDb->getProfilePic();
    ...
    public function readDataByIdAction(int $id): void
    {
        ...
        // * Create Data
        $responseData["id"] = $id;
        $responseData["firstName"] = $dataDb->getFirstName();
        $responseData["lastName"] = $dataDb->getLastName();
        $responseData["username"] = $dataDb->getUsername();
        $responseData["email"] = $dataDb->getEmail();
        $responseData["phone"] = $dataDb->getPhone();
        $responseData["password"] = $dataDb->getPassword();
        $responseData["pin"] = $dataDb->getPin();
        $responseData["isActive"] = $dataDb->getIsActive();
        $responseData["isLogin"] = $dataDb->getIsLogin();
        $responseData["isResetPassword"] = $dataDb->getIsResetPassword();
        $responseData["lastLogin"] = $dataDb->getLastLogin();
        $responseData["profilePic"] = $dataDb->getProfilePic();
    ...
    public function updateDataByPatchAction(int $id): void
    {
        ...
        $updateData->assign(
            (array) $jsonRequest,
            [
                "firstName", "lastName", "username", "email", "phone", "password", "pin", "isActive", 
                "isLogin", "isResetPassword", "lastLogin", "profilePic"
            ]
        );
        if ($updateData->save() === false) {
            throw new \Exception("failed to update", 400);
